...
const landingCarouselCardBaseClass =
  "group absolute left-1/2 top-1/2 block aspect-[5/4] w-[clamp(196px,22vw,232px)] cursor-pointer overflow-hidden rounded-[18px] border border-white/[0.07] bg-[linear-gradient(180deg,rgba(22,24,32,0.94),rgba(10,12,18,0.92))] p-[14px_14px_12px_14px] text-left no-underline outline-none [-webkit-backdrop-filter:blur(14px)] [backdrop-filter:blur(14px)] [box-shadow:inset_0_1px_0_rgba(255,255,255,0.07),inset_0_-1px_0_rgba(255,255,255,0.03),0_28px_60px_-28px_rgba(0,0,0,0.95),0_0_56px_-26px_rgba(124,92,255,0.55)] [transform-style:preserve-3d] [will-change:transform,opacity,filter] focus-visible:[box-shadow:inset_0_1px_0_rgba(255,255,255,0.10),0_0_0_2px_rgba(124,92,255,0.65),0_28px_60px_-28px_rgba(0,0,0,0.95)] max-[640px]:w-[clamp(176px,58vw,208px)] max-[640px]:rounded-[16px] max-[640px]:p-[12px]"
...
const landingCarouselCtaClass =
  "absolute left-1/2 top-1/2 z-[5] inline-flex items-center gap-[8px] whitespace-nowrap rounded-full border border-white/[0.12] bg-[rgba(12,14,20,0.78)] px-[12px] py-[7px] text-[11px] font-[620] tracking-[0.04em] text-white/88 no-underline outline-none [-webkit-backdrop-filter:blur(10px)] [backdrop-filter:blur(10px)] [box-shadow:inset_0_1px_0_rgba(255,255,255,0.08),0_18px_38px_-20px_rgba(0,0,0,0.9),0_0_28px_-12px_rgba(124,92,255,0.62)] [font-family:var(--font-ui)] hover:bg-[rgba(18,20,28,0.86)] hover:[box-shadow:inset_0_1px_0_rgba(255,255,255,0.10),0_22px_44px_-20px_rgba(0,0,0,0.95),0_0_36px_-12px_rgba(124,92,255,0.78)] focus-visible:[box-shadow:inset_0_1px_0_rgba(255,255,255,0.10),0_0_0_2px_rgba(124,92,255,0.78),0_22px_44px_-20px_rgba(0,0,0,0.95)] max-[640px]:px-[11px] max-[640px]:py-[6px] max-[640px]:text-[10.5px]"
